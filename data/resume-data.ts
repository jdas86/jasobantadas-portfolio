export const resumeData = {
  basics: {
    ...
    links: [
      { label: "LinkedIn", value: "jasobanta-das-496b1389", href: "https://www.linkedin.com/in/jasobanta-das-496b1389" },
      { label: "GitHub", value: "jdas86", href: "https://github.com/jdas86" }
    ]
  },
  experience: [
    {
  ...
  projects: [
    {
      ...
      stack: ["ML Solution Architecture", "ML Pipelines", "Feature Engineering", "Model Deployment", "MLOps", "Predictive Analytics"],
      bullets: [
    ...
    {
      title: "Snowflake Specialization",
      stack: ["Snowflake", "RBAC", "Warehousing", "Data Sharing", "Optimization"],
      bullets: [
  ...
  skills: [
    {
      group: "Cloud Data Platform Architecture",
      items: ["AWS", "Databricks Lakehouse", "Snowflake", "scalable, governed, and enterprise-ready data platforms"]
    },
    {
      group: "Data Architecture & Specialization",
      items: ["Enterprise Data Platform", "Lakehouse Design", "Data Warehousing", "Medallion Architecture", "Data Modeling", "Consumption Layer Design"]
    },
    {
      group: "Big Data & Streaming Architecture",
      items: ["Apache Spark", "Kafka", "Kinesis", "Delta Live Tables", "Hadoop", "batch and real-time data processing frameworks"]
    },
    {
      group: "Machine Learning & AI Architecture",
      items: ["ML Solution Architecture", "ML Pipelines", "Feature Engineering", "Model Deployment", "MLOps", "Predictive Analytics"]
    },
    {
      group: "Data Engineering & Integration",
      items: ["End-to-end pipeline design", "ETL/ELT Architecture", "API-driven integration", "Cloud-native and on-premise", "Informatica IICS"]
    },
    {
      group: "Governance, Security & Metadata",
      items: ["Unity Catalog", "AWS Glue Catalog", "RBAC", "Metadata Management", "Data Quality", "Lineage", "Lifecycle Management"]
    },
    {
      group: "DevOps, CI/CD & Platform Automation",
      items: ["Terraform", "Jenkins", "GitHub Actions", "Infrastructure as Code", "CI/CD", "deployment and environment automation"]
    },
    {
      group: "Performance, Scalability & Cost Optimization",
      items: ["Workload optimization", "compute strategy", "storage design", "performance tuning", "cost-efficient architecture"]
    }
  ],
  education: [],
  certifications: [
